...
class ModelObjectDetection {
  ...
  Future<List<ResultObjectDetection>> getCameraImagePredictionList(CameraImage cameraImage,
      {int? rotation,
      double minimumScore = 0.5,
      double iOUThreshold = 0.5,
      int boxesLimit = 10,
  ...
  /// The optional parameters [minimumScore], [iOUThreshold], [boxesLimit], [cameraPreProcessingMethod], and [preProcessingMethod]
  /// allow customization of the prediction process.
  Future<List<ResultObjectDetection>> getCameraImagePrediction(CameraImage cameraImage,
      {int? rotation,
      double minimumScore = 0.5,
      double iOUThreshold = 0.5,
      int boxesLimit = 10,
      CameraPreProcessingMethod cameraPreProcessingMethod = CameraPreProcessingMethod.imageLib,
      PreProcessingMethod preProcessingMethod = PreProcessingMethod.imageLib}) async {
    final List<ResultObjectDetection> prediction = await getCameraImagePredictionList(cameraImage,
        rotation: rotation,
        minimumScore: minimumScore,
        iOUThreshold: iOUThreshold,
        boxesLimit: boxesLimit,
